...
class Reader_APNEWS:
    ...
    """
    def __init__(self, datapath, n_features=100000, lm_minimum_freq=5, train_perc=0.6, valid_perc= 0.2, language="english"
                 , length_batch=10, batch_size=5, sample_size=10000):
        #data preprocessing
        ...
        self.tf_vectorizer = CountVectorizer(max_df=0.95, min_df=10,
